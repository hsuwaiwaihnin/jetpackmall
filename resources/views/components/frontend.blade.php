      ...
      <div id="carouselExampleControls" class="carousel slide " data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="img-box">
              <img src="frontend/images/slider-img.jpg" alt="">
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="info_contact">
        <div class="row">
          ...
          <div class="col-md-4">
            <a href="">
              <img src="frontend/images/call.png" alt="">
              <span>
                Call : +012334567890
              </span>
            </a>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          <div class="info_social">
            <div>
              <a href="">
                <img src="frontend/images/facebook-logo-button.png" alt="">
              </a>
            </div>
            <div>
              <a href="">
                <img src="frontend/images/twitter-logo-button.png" alt="">
              </a>
            </div>
            <div>
              <a href="">
            ...
            <div>
              <a href="">
                <img src="frontend/images/instagram.png" alt="">
              </a>
            </div>
          </div>
        </div>
